...
class HomeController extends Controller
{
    public function index() {
        ...
        // ho provato a creare il file .php in config e utilizzare il metodo config() ma non sembra funzionare, correggo in seguito
        // il file php in config creato si chiama serie
        $serie = [
            [
